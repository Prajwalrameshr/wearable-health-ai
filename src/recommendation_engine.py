def generate_recommendations(analysis_result: dict) -> list[str]:
    """Generate personalized health recommendations based purely on physiological state, trends, and risk index."""
    ...
    if risk["level"] == "High":
        recommendations.append("Make the next 24 to 48 hours recovery-focused to stabilize physiological strain.")
